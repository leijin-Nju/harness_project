...
- [ ] **Step 3: Add project metadata and minimal models**
...
- [ ] **Step 1: Write failing tests for parsing and mock LLM**
...
- [ ] **Step 3: Implement action parsing and LLM classes**
...
- [ ] **Step 1: Write failing path fence tests**
...
- [ ] **Step 3: Implement JSON approval persistence**
...
- [ ] **Step 3: Implement config and credentials**
...
- [ ] **Step 3: Implement the self-owned loop**
...
- [ ] **Step 4: Run demo tests and command**
...
- [ ] **Step 3: Create and update documentation**
